...
MIDDLEWARE = [
    ...
    "sundowns_app.middleware.FeatureFreezeMiddleware",
...
ROOT_URLCONF = 'sundowns_app.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'branches.context_processors.branch_admin_context',
            ],
        },
    },
]

WSGI_APPLICATION = 'sundowns_app.wsgi.application'
